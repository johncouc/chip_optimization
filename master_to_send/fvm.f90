...
CONTAINS
    ...
    SUBROUTINE fvm_simulate(v, d,DAT,IDAT)
        INTEGER, intent(in)::d
        INTEGER	:: l,b,a,i, j, ii, jj, m,tot,el 
        ...
        DO l = 1,n
            ...
            ! Initialize xi & interpolate conductivities of each side
    ...
    END SUBROUTINE
        ...
        ! callback function - used to implement SIMP strategy
